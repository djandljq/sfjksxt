    ...
    <yd-flexbox class="goods_order_content" direction="vertical">
      ...
      <yd-flexbox-item class="goods_order_content_goods">
        ...
        <div class="goods_order_content_goods_price">
          ...
          <span class="total_freight">运费：<span class="number">{{freight}}</span></span>
    ...
    getOrderInfo () {
      ...
      orderInfoBySn(sn).then(data => {
        ...
        attributes.forEach(attribute => {
          ...
          if (attribute.attr_type === 'explain' && attribute.attr_code === 'freight') {
            this.freight = attribute.attr_value;
          }
        });
        users.forEach(user => {
